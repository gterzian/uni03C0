...
public enum PiError: Error, Sendable, LocalizedError {
    ...
    public var errorDescription: String? {
        switch self {
        case .processNotRunning: "pi process is not running"
        case .launchFailed(let detail): "failed to launch pi: \(detail)"
